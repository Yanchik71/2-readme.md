...
divmod — вернет частное и остаток от деления двух чисел;
 numerate  — вернет объект, который генерирует кортежи из двух элементов (индекса и самого элемента);
...
open — откроет файл и вернет его объект.Справочник команд python 
